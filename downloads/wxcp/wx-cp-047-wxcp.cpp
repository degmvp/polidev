// wx-cp-047-wxcp.cpp
// Migrado do acervo legado: cppb08.cpp
// POLYDEV | WXCP
// Título: Validação de bloco de memória potência de 2
...
bool validateBlockSize(std::uint32_t s){return isPowerOfTwo(s);} int main(){std::cout<<std::boolalpha<<"64: "<<validateBlockSize(64)<<" 70: "<<validateBlockSize(70)<<'\n';}
