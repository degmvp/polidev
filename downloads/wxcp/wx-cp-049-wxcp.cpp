// wx-cp-049-wxcp.cpp
// Migrado do acervo legado: cppb10.cpp
// POLYDEV | WXCP
// Título: Hash simples com rotações bitwise
...
std::uint32_t generateHash(std::uint32_t key){return rotateLeft(key,7)^rotateRight(key,3);} int main(){std::cout<<"Hash: "<<generateHash(12345)<<'\n';}
