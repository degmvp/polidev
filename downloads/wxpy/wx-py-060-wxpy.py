...
class Pipeline(Generic[T]):
    ...
    Args:
        steps: Lista de funções (callable) a serem aplicadas em ordem.
    """
...
#     .on_error(lambda e, step, data: data)  # ignora erros, mantém dado atual
# )
#
...
#
# for entry in pipeline.get_history():
